...
export default function Hard(): JSX.Element {
    ...
    function handle_click(): void {
        if(inp.current){
            ...
            if(val == num){
                set_wins(wins + 1);
                localStorage.setItem("hard_wins", (wins + 1).toString());
            ...
            if(counter == 1 && val != num){
                set_loses(loses + 1);
                localStorage.setItem("hard_loses", (loses + 1).toString());
    ...
    useEffect(function (): void {
        const saved_wins: string = localStorage.getItem("hard_wins") || "0";
        const saved_loses: string = localStorage.getItem("hard_loses") || "0";
        setTimeout(function (): void {
    ...
    return (
        <div className={styles.page}>
            ...
            <main className={styles.main}>
                <h1 className={player_status != "Win." && player_status != "Lose." ? styles.main_title : styles.none}>Hard Mode</h1>
